...
export default function OrderTrackingPage() {
  ...
  axios
    ...
    .then((res) => {
      ...
      // El backend ahora devuelve { success: true, data: { sales: [...], userRole: "...", ... } }
      if (res.data.data?.sales) {
        allSalesData = res.data.data.sales;
  ...
  const fetchTiendas = () => {
    axios
      ...
      .then((res) => {
        // El backend ahora devuelve { success: true, data: [...tiendas...] }
        const tiendasData = res.data.data || res.data || [];
