    ...
    <div style={{ backgroundColor: '#f4f6fa', minHeight: '100vh' }}>
      <div className="max-w-7xl mx-auto p-6">
              ...
              <button
                  onClick={() => {
                    ...
                    if (mostrarReabastecimiento) {
                      ...
                      // ✅ NUEVO: Auto-scroll al abrir reabastecimiento
                      scrollToElement('reabastecimiento-form');
                    }
                  }}
              ...
              <button
                  onClick={() => {
                    if (mostrarFormulario) {
                      ...
                      limpiarFormularioCompleto();
                      setMostrarFormulario(true);
                      // ✅ NUEVO: Auto-scroll al abrir formulario nuevo
                      scrollToElement('producto-form');
                    }
                  }}
                  className="px-6 py-3 rounded-lg font-medium text-white transition-all duration-200 hover:shadow-lg transform hover:scale-105"
                  ...
                  <div key={producto._id} className="bg-white rounded-lg p-4 border border-orange-200">
                    ...
                    <button
                      onClick={() => {
                        ...
                        // ✅ NUEVO: Auto-scroll desde alertas de stock bajo
                        scrollToElement('reabastecimiento-form');
                      }}
        ...
        {mostrarReabastecimiento && (
          <div id="reabastecimiento-form" className="bg-white rounded-xl shadow-lg p-6 mb-8 border-2 border-green-200">
        ...
        {mostrarFormulario && (
          <div id="producto-form" className="bg-white rounded-xl shadow-lg p-6 mb-8 border" style={{ borderColor: '#e5e7eb' }}>
                      ...
                      <div className="flex gap-3">
                          <button
                            onClick={() => {
                              ...
                              setMostrarReabastecimiento(true);
                              // ✅ NUEVO: Auto-scroll hacia formulario de reabastecimiento
                              scrollToElement('reabastecimiento-form');
                            }}
                          ...
                          <button
                            onClick={() => {
                              handleEdit(product);
                              // ✅ NUEVO: Auto-scroll hacia formulario de edición
                              scrollToElement('producto-form');
                            }}
                            className="px-6 py-3 rounded-lg font-medium text-white transition-all duration-200 hover:shadow-md"
