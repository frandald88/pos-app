...
const saleSchema = new mongoose.Schema({
  ...
  // ✨ NUEVO: Propina (para ventas de restaurant)
  tip: {
    amount: {
      type: Number,
      default: 0,
  ...
  // ✨ NUEVO: Link a cuenta de restaurant (si aplica)
  sourceAccount: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'Account',
    default: null
  ...
  // ✨ NUEVO: Información de mesa y mesero (denormalizado para reportes)
  restaurantInfo: {
    tableNumber: String,
    tableId: { type: mongoose.Schema.Types.ObjectId, ref: 'Table' },
    waiterId: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
    waiterName: String,
    splitNumber: Number, // Si es parte de split bill (1, 2, 3...)
    guestCount: Number
  },
  tienda: {
    type: mongoose.Schema.Types.ObjectId,
