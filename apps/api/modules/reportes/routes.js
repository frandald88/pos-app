...
const { identifyTenant, requireTenant, checkFeatureAccess } = require('../../shared/middleware/tenantMiddleware');
...
router.get("/ventas", verifyToken, identifyTenant, requireTenant, checkFeatureAccess('reports'), requireAdmin, async (req, res) => {
  try {
...
router.get("/ventas/resumen", verifyToken, identifyTenant, requireTenant, checkFeatureAccess('reports'), requireAdmin, async (req, res) => {
  try {
...
router.get("/productos/top", verifyToken, identifyTenant, requireTenant, checkFeatureAccess('reports'), requireAdmin, async (req, res) => {
  try {
...
router.get("/usuarios/performance", verifyToken, identifyTenant, requireTenant, checkFeatureAccess('reports'), requireAdmin, async (req, res) => {
  try {
...
router.get("/ventas/mixed-payments", verifyToken, identifyTenant, requireTenant, checkFeatureAccess('reports'), requireAdmin, async (req, res) => {
  try {
    const { inicio, fin, tiendaId } = req.query;
...
router.get("/ventas/payment-combinations", verifyToken, identifyTenant, requireTenant, checkFeatureAccess('reports'), requireAdmin, async (req, res) => {
  try {
    const { inicio, fin, tiendaId } = req.query;
