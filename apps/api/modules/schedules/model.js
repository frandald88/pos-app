...
// ✅ CORREGIDO: Índices mejorados para evitar conflictos (con multi-tenancy)
// Índice para asignaciones de empleados (solo cuando no es plantilla)
scheduleSchema.index(
  { tenantId: 1, employee: 1, isActive: 1 },
  {
    unique: true,
...
scheduleSchema.index({ tenantId: 1, isTemplate: 1, isActive: 1 });
